...
// initialize text element on hover
  ...
  let datagroups = graphGroup.selectAll(".datagroup").data(data).enter()
    .append("g")
      ...
      .on("mouseover", function(d, i){
        ...
        // another way to make the selecting dp stand out
        ...
        // .transition()
        // .delay(function(d, i){
        //   return i*10  // millisecond
        // })
        // .attr("r", 1)

        // datagroups.transition().attr("opacity", 0.2)
        // d3.select(this)  // selects the element we click
        // // .select("circle")
        // .transition()
        // // .attr("r", 15)
        // .attr("opacity", 1)
        ...
        // console.log(d3.mouse(viz.node()));  // mouse location within the viz 
      ...
      .on("mouseout", function(d, i){
        // console.log(d.event);
        // datagroups.transition().attr("opacity", 1)
        // d3.select(this)
        // .select("circle")
        // .transition()
        // .attr("r", 15)
